...
@section("content")
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="{{route('backend.supplier.update',['id'=>$data->id])}}">
                {!! csrf_field() !!}
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="供应商名称" value="{{old('name',$data->name)}}">
                        </div>
                    </div>
