...
@section("content")
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="{{route('backend.procurement.update',['id'=>$data->id])}}">
                {!! csrf_field() !!}
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="采购单名称" value="{{old('name', $data->name)}}">
                        </div>
                        <div class="form-group">
                            <label for="standard">供应商<em>*</em></label>
                            <select name="supplier_id" id="supplier_id" class="form-control">
                                @foreach($supplierList as $key => $value)
                                    <option value="{{$key}}" @if($key === $data->supplier_id) selected @endif>{{$value}}</option>
                                @endforeach
                            </select>
                         </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                         ...
                         <select name="buyer_id" id="buyer_id" class="form-control">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="amount" name="amount" placeholder="数量" value="{{old('amount', $data->amount)}}">
                          </div>
                    </div>
